...
- [`day-in-the-life-15/`](day-in-the-life-15/README.md) — a cross-repo foreground-context workflow: a human asks the foreground AI to load selected related repositories into context, classify their roles, extract transferable patterns, and preserve current-repo authority without smearing every project into one soup.
