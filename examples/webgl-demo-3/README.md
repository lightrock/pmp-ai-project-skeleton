...
For this example, the important cognition is:

- PFEM and PFCOMM are not the same thing.
- Evidence, status, role, command, package, and rollup concepts should not be collapsed.
